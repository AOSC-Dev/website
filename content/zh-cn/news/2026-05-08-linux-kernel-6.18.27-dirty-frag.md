...
2026 年 5 月 8 日，独立安全研究员 Hyunwoo Kim [披露了](https://www.openwall.com/lists/oss-security/2026/05/07/8) Linux 内核 `esp4`、`esp6` 及 `rxrpc` 模块中的一系列漏洞（代号 [Dirty Frag](https://github.com/V4bel/dirtyfrag)），可通过恶意程序实现本地提权。
